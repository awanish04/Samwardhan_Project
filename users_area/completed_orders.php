...
<body>
    <h3 class="text-success">Completed Orders</h3>
    ...
    $username=$_SESSION['username'];
        $get_order_details="Select * from `orders_pending` where username='$username' and payment_status=1 and delivery_status=1 ORDER BY order_id DESC";
